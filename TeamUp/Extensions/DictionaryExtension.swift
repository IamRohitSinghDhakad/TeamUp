...
//  MESHAI
//
//  Created by Ideal IT Techno on 23/10/17.
//  Copyright © 2017 Ideal IT Techno. All rights reserved.
//
...
extension NSMutableDictionary {
    ...
    func Set(value: Any, forKey key: String!) {
        if self.object(forKey: key as Any) != nil {
    ...
    func ReomoveObject(forKey key: String!) {
        self.removeObject(forKey: key as Any)
    }
